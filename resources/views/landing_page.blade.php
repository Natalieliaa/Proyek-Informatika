...
@section('content')
    <div class="landing-container">
        ...
        <div class="button-section">
            <div class="button-group">
                ...
                <!-- Tombol Admin -->
                <a href="{{ route('admin.login') ?? '#' }}" class="custom-button">admin</a>
            </div>
    ...
    <div id="registerModal" class="modal-overlay">
        <div class="modal-content">
            ...
            <a href="{{ route('register.customer') ?? '#' }}" class="modal-button">Daftar Sebagai Customer</a>
            <!-- Asumsi route pendaftaran seller -->
            <a href="{{ route('register.seller') ?? '#' }}" class="modal-button">Daftar Sebagai Seller</a>
